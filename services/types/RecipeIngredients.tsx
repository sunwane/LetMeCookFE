...
export const getAllRecipeIngredientsByRecipeId = async (): Promise<ApiResponse<RecipeIngredientsResponse[]>> => {
  ...
  const response = await fetch(`${API_BASE_URL}/recipeIngredients/crete`, {
    method: 'GET',
    headers,
  });
